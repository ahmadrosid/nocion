    ...
    <div className="p-2 flex justify-between">
      <div className="relative" ref={refTitleContainer}>
        <div className="flex items-center">
          <p
            className={clsx(
              "hover:bg-hover px-2 py-1 rounded-md cursor-pointer block",
              isShowToggle && "hidden"
            )}
          ...
          <div
            ...
            ref={refTitle}
            className="hover:bg-hover px-2 py-1 rounded-md cursor-pointer"
          >
            {contentTitle}
          </div>
        </div>
        {showEditTitle && (
          <div className="bg-white rounded shadow-lg p-1 border border-[#dadada] flex items-center gap-2 absolute left-0 w-[350px]">
            ...
            <form onSubmit={handleSubmitUpdateTitle} className="w-full">
              <input
                name="title"
                className="text-sm w-full max-w-[400px] bg-gray-1 rounded px-1.5 py-1 border border-[#dadada] focus:outline-none"
                type="text"
      ...
      <div className="flex items-center gap-1">
        <div className="hover:bg-hover px-2 py-1 rounded-md cursor-pointer">
          Share
        </div>
        ...
        <div className="text-gray-600 hover:bg-hover cursor-pointer p-1 px-1.5 rounded">
          <svg viewBox="0 0 13 3" className="w-5 h-5" fill="currentColor">
            <g>
