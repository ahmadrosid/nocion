        ...
        <div className="p-2 flex justify-between">
            <div className="relative" ref={refTitleContainer} >
                <div className="flex items-center">
                    <p className={`hover:bg-hover px-2 py-1 rounded-md cursor-pointer block ${isShowToggle && 'hidden'}`} onClick={toggleSidebar}>
                ...
                {showEditTitle && (
                    <div className="bg-white rounded shadow-lg py-1 px-2 border border-[#dadada] flex items-center gap-2 absolute left-0 w-[350px]">
