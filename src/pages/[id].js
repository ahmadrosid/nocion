                ...
                <div className="xl:w-[900px] md:w-[650px] px-16 mx-auto">
                    <div>
                        <div className="px-2 pt-[78px] group">
                            <div className="p-2 hover:bg-hover max-w-[95px] rounded cursor-pointer">
                                <img src="https://notion-emojis.s3-us-west-2.amazonaws.com/v0/svg-twitter/1f94d.svg" className="max-w-[85px]" />
                            </div>
                            <div className="pt-2 flex gap-2 invisible group-hover:visible">
                                <div>
                                    <p className="text-[#37352f81] text-sm p-1 flex items-center gap-2 rounded cursor-pointer hover:bg-hover" >
                                        <svg viewBox="0 0 14 14" class="w-4 h-4" fill="currentColor">
                                ...
                                <div>
                                    <label for="content-icon" className="text-[#37352f81] text-sm p-1 flex items-center gap-2 rounded cursor-pointer hover:bg-hover" >
                                        <svg viewBox="0 0 14 14" class="w-4 h-4" fill="currentColor">
                                    ...
                                    <input id="content-icon" type="file" className="input-file" />
                                </div>
                                <div>
                                    <p className="text-[#37352f81] text-sm p-1 flex items-center gap-2 rounded cursor-pointer hover:bg-hover" >
